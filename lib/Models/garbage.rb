################ Welcome Screen ##################################################
  ...
  def get_input
    welcome
    prompt = "Type 1) to log in or type or 2) to create a new account."
    puts
    puts prompt
...
###################### Trending Stocks ###########################################
  def trending_stocks
    ...
    puts "#{mover['companyName']}".blue + " Percent Increase:" + " #{mover['changesPercentage']}".green
    puts
    end
    puts "--------------------------------------------------------------------------"
    ...
    biggest_negative_movers.each do |mover|
      mover["companyName"]
      puts "#{mover['companyName']}".blue + " Percent Decrease:" + " #{mover['changesPercentage']}".red
      puts
      end
